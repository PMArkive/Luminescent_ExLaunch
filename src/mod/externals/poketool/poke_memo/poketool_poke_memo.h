...
namespace poketool::poke_memo {
    struct poketool_poke_memo : ILClass<poketool_poke_memo> {
        ...
        static inline void ClearPlaceTime(Pml::PokePara::CoreParam::Object* pParam, int32_t type) {
            external<void>(0x02bacca0, pParam, type);
        }

        static inline void SetPlaceTime(Pml::PokePara::CoreParam::Object* pParam, uint32_t placeNo, int32_t dataType) {
